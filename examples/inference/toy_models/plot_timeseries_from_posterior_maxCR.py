...
nnm = CNNModel(input_shape=(ts_len,nr_of_species), output_shape=(15), con_len=3, con_layers=clay, dense_layers=[100,100,100],dataname="C_and_R")
...
obs_data = np.zeros((nrs,num_timestamps,2))
