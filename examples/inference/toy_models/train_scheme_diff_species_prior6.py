rom train_function import train_routine
import numpy as np
...
end_step = [201,101,51]
for i in range(3):
    train_routine(modelname=modelname, dmin=dmin, dmax=dmax, species=species[6], training_size=300000, step=1,
                  end_step=end_step[i], dataname=dataname, pooling_len=2, dlay=[400,400,400], model='CNN',
                  res_folder="diff_end_step")
