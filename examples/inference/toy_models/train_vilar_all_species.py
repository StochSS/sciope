...
nnm = CNNModel(input_shape=(ts_len,train_ts.shape[2]), output_shape=(15), con_len=3, con_layers=clay, pooling_len=2, dense_layers=[100,100,100])
...
history2 = nnm.train(inputs=train_ts, targets=train_thetas,validation_inputs=validation_ts,validation_targets=validation_thetas,
          batch_size=4096, epochs=5*10, val_freq=1, early_stopping_patience=5, plot_training_progress=False,verbose=2)
