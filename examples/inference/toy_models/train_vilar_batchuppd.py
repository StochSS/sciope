...
for base in range(4,12):
    ...
    history1 = nnm.train(inputs=train_ts, targets=train_thetas,validation_inputs=validation_ts,
                         validation_targets=validation_thetas, batch_size=batch_size, epochs=40*10, val_freq=1,
                         early_stopping_patience=1, plot_training_progress=False, verbose=verb)
