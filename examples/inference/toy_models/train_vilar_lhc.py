...
train_thetas = pickle.load(open('datasets/lhc2/' + modelname + '/train_thetas_.p', "rb" ) )
train_ts = pickle.load(open('datasets/lhc2/' + modelname + '/train_ts_.p', "rb" ) )
...
nnm = PEN_CNNModel(input_shape=(ts_len,train_ts.shape[2]), output_shape=(15), pen_nr=10, con_layers=[100,100,100], dense_layers=[100,100,100])
