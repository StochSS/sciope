...
"""
# Imports
from feature_extraction_base import FeatureExtractionBase
...
class TimeSeriesAnalysis(FeatureExtractionBase):
    ...
    def put(self, data):
        ...
        idx = np.asarray(
            [[x] * data.shape[1] for x in range(nr_datapoints, nr_datapoints + data.shape[0])])  # creating indices
    ...
    def generate(self, fc_params=None, dask_client=None, progressbar_off=False):
        ...
        try:
            ...
            print
            'All datapoints in __.data has already been computed or data is missing.\
